...
public class FolderLooper {
	...
	public ArrayList<String> subFolder2ArrayCreator() {
		subFolderDirectory2 = subFolderPathArray1.get(array1MethodIterator);
	...
	public ArrayList<String> subFolder3ArrayCreator() {
		subFolderDirectory3 = subFolderPathArray2.get(array2MethodIterator);
		...
		for (String folderName3 : fileListings3) {
			if (new File(subFolderDirectory3 + "\\" + folderName3).isDirectory()) {
				folderListings2[array3MethodIterator] = subFolderDirectory3 + "\\" + folderName3;
